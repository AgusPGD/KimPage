...
import logo from '/src/assets/logoKim.png'
import comidaImg from '/src/assets/comidaKim.png'
import feriadoImg from '/src/assets/feriadoProyecto.png'
import patioImg from '/src/assets/patioKim.png'
import cartelImg from '/src/assets/cartelKim.png'
...
function App() {
  ...
  return (
    <>
    <div className = "contenedorPrincipal" style={styles.fondo}>
...
Sea cual sea el día, en Kimberly siempre te recibimos con los brazos abiertos, buena comida y ese ambiente familiar que tanto nos caracteriza. ¡Te esperamos!" h2texto="ESTAMOS ABIERTOS" img={cartelImg} id={2}></CardTablon>
...
Y, por supuesto, nuestra gran Milanga: un bife entero hecho milanesa acompañado de pastas a la carbonara. En Kimberley, cada plato es una experiencia. ¡Vení a disfrutar!" h2texto="ESPECIALIDADES" img={comidaImg} id={3}> </CardTablon>
          <CardTablon  texto="En el Bodegón Kimberley celebramos los pequeños placeres de la vida con nuestro Vermú Feriado, disponible en dos deliciosos sabores: Malbec y Rosé. Podés disfrutarlo como un trago para acompañar tus platos favoritos o llevar la experiencia al siguiente nivel con nuestra imperdible promo, que incluye la botella completa y un sifón de regalo." h2texto="FERIADO" img={feriadoImg} id={4}></CardTablon>
        </div>
